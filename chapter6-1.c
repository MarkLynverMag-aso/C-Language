...
// Absolute Beginner's Guid to C, 3rd Edition
// File chapter6-1.c

// This program pairs three kids with thier favorite superhero
...
int main()
{
    ...
    char Kid2[] = "Maddie";
    //Kid3 is also 6 characters, but specifically defined
    char Kid3[7] = "Andrew";
    //Hero1 will be 7 charactgers (adding null 0!)
    char Hero1[] = "Batman";
